  ...
  projects: [
    {
      ...
      features: [
        ...
        'Assignments, schedule, and course learning views',
        'Parent payment, report card, and child progress tracking',
        'Chat, notifications, and profile management',
        'Leave request submission and school-side handling',
      ],
      preview: {
        ...
        screenshot: '/schoolflow-project/student home.png',
        screenshots: [
          {
            id: 1,
          ...
          {
            id: 10,
            src: '/schoolflow-project/parent view child attendance 1.png',
            title: 'Parent Child Attendance Overview',
            description: 'Attendance summary for a selected child.',
          },
          {
            id: 11,
            src: '/schoolflow-project/parent view child attendance 2.png',
            title: 'Parent Child Attendance Detail',
            description: 'Detailed attendance records for parent review.',
          },
          {
            id: 12,
